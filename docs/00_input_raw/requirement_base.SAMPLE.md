# requirement_base — INPUT THÔ (bản mẫu / archive)

> **Đã chuyển SSOT sang** [`requirement_base.md`](requirement_base.md). File này giữ để tham chiếu pack template.  
> **Sản phẩm:** Ứng dụng học tiếng Anh giao tiếp công việc (English Learning Application for Workplace Communication)  
...
| AI Services | OpenAI API, Whisper API, Text-to-Speech API |
...
| Thành phần | Mô tả |
|------------|--------|
| Mobile Application | UI/UX, Audio player, Flashcard, Speaking practice, Context learning |
| Backend API | Business logic, Learning engine, AI integration, Vocabulary engine |
| Supabase | PostgreSQL, Realtime sync, Storage |
...
**Style:** Minimal, modern, mobile-first, dark mode, clean typography.
