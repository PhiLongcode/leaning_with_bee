<!-- @file: src/fn09_pronunciation_scoring/02_dev_plan_checklist.md | @role: Dev plan — REQ-09 -->

# Dev plan — Pronunciation Scoring
...
| Field | Value |
|-------|-------|
| FN | fn09_pronunciation_scoring — Pronunciation Scoring |
| REQ | REQ-09 |
...
- [ ] Đã đọc `00_requirement_business.md` (REQ-09), `00_global_lesson_learn.md`, `00_global_issue_log.md`.
- [ ] `docs/01_specification/features/pronunciation_scoring.feature` có scenario cho AC chính (hoặc defer có lý do trong `03_debate.md`).
- [ ] Rà `docs/02_system_design/` — cập nhật hoặc ghi **no contract change — ngày 2026-05-28**.
- [ ] (Khi có `src/`) Biết module/layer sẽ sửa: POST `/pronunciation-score`, UI hiển thị tiêu chí, persist score cho FN-10..
- [ ] Branch/issue gắn REQ-09.
...
1. Mở [`01_requirement.md`](01_requirement.md) + dòng REQ-09 trong [`00_requirement_business.md`](../../process/00_requirement_business.md).
2. Rà [`00_global_lesson_learn.md`](../../process/00_global_lesson_learn.md), [`00_global_issue_log.md`](../../process/00_global_issue_log.md) (keyword: fn09_pronunciation_scoring).
3. Liệt kê entity/API: POST `/pronunciation-score`, UI hiển thị tiêu chí, persist score cho FN-10..

| | |
|--|--|
| **Input** | `01_requirement.md`, `00_requirement_business.md` (REQ-09), global lesson/issue |
...
- [ ] File `.feature` cho Pronunciation Scoring (scenario từ §6 Gherkin).
- [ ] Contract/design đã rà hoặc ghi no-change.

**Step-by-step**

1. Sinh/sửa [`docs/01_specification/features/pronunciation_scoring.feature`](../../docs/01_specification/features/pronunciation_scoring.feature) (`01-bdd-spec.mdc`).
2. Rà `docs/02_system_design/` — API/DB cho REQ-09.
...
- [ ] PR nhỏ, link REQ-09 + `.feature`.

**Step-by-step**

1. Entity, use case, ports (`02-clean-solid.mdc`) — POST `/pronunciation-score`, UI hiển thị tiêu chí, persist score cho FN-10..
...
2. E2E cho luồng chính Pronunciation Scoring; cover AC trong ma trận DoD.
...
|---------------------------------------|------------------------------|------|
| Điểm + 4 tiêu chí hiển thị | _(test / PR / demo)_ | [ ] |
| Lưu score vào log | _(test / PR / demo)_ | [ ] |
| Phụ thuộc output FN-08 | _(test / PR / demo)_ | [ ] |
