...
| Field | Value |
|-------|-------|
| FN | fn08_speech_to_text — Speech-to-Text |
| REQ | REQ-08 |
...
- [ ] Đã đọc `00_requirement_business.md` (REQ-08), `00_global_lesson_learn.md`, `00_global_issue_log.md`.
- [ ] `docs/01_specification/features/speech_to_text.feature` có scenario cho AC chính (hoặc defer có lý do trong `03_debate.md`).
- [ ] Rà `docs/02_system_design/` — cập nhật hoặc ghi **no contract change — ngày 2026-05-28**.
- [ ] (Khi có `src/`) Biết module/layer sẽ sửa: Màn Speaking Practice, ghi âm mobile, POST `/speech-to-text`, diff UI với mẫu..
- [ ] Branch/issue gắn REQ-08.
...
1. Mở [`01_requirement.md`](01_requirement.md) + dòng REQ-08 trong [`00_requirement_business.md`](../../process/00_requirement_business.md).
2. Rà [`00_global_lesson_learn.md`](../../process/00_global_lesson_learn.md), [`00_global_issue_log.md`](../../process/00_global_issue_log.md) (keyword: fn08_speech_to_text).
3. Liệt kê entity/API: Màn Speaking Practice, ghi âm mobile, POST `/speech-to-text`, diff UI với mẫu..

| | |
|--|--|
| **Input** | `01_requirement.md`, `00_requirement_business.md` (REQ-08), global lesson/issue |
...
- [ ] File `.feature` cho Speech-to-Text (scenario từ §6 Gherkin).
- [ ] Contract/design đã rà hoặc ghi no-change.

**Step-by-step**

1. Sinh/sửa [`docs/01_specification/features/speech_to_text.feature`](../../docs/01_specification/features/speech_to_text.feature) (`01-bdd-spec.mdc`).
2. Rà `docs/02_system_design/` — API/DB cho REQ-08.
...
- [ ] PR nhỏ, link REQ-08 + `.feature`.

**Step-by-step**

1. Entity, use case, ports (`02-clean-solid.mdc`) — Màn Speaking Practice, ghi âm mobile, POST `/speech-to-text`, diff UI với mẫu..
...
2. E2E cho luồng chính Speech-to-Text; cover AC trong ma trận DoD.
...
|---------------------------------------|------------------------------|------|
| STT trả text từ audio | _(test / PR / demo)_ | [ ] |
| So sánh/highlight lỗi UI | _(test / PR / demo)_ | [ ] |
| API contract ổn định | _(test / PR / demo)_ | [ ] |
