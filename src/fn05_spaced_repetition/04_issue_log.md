<!-- @file: src/fn05_spaced_repetition/04_issue_log.md | @role: Issue index — REQ-05 -->

# Issue log — Học theo Spaced Repetition
...
_(Paste block từ `issue_loop_template.md` khi mở ISS-001.)_
