...
- [ ] `src/fn01_*/` đầu tiên: `01_requirement.md`, `02_dev_plan_checklist.md`, `03`–`05` (cùng module — rule `12-src-feature-docs.mdc`)
- [ ] `prompt_history/00_index.md` + `README.md`
- [x] `docs/02_system_design/sys_design_ux_ui.md`, `sys_design_techstack.md`, `api_specs/api_design.md` (SSOT dự án)
