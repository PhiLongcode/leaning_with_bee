...
> Luồng: `requirement_base.md` → **`00_requirement_business.md`** (tổng) → **`src/fnxx/01_requirement.md`** (từng FN) → **`src/fnxx/02_dev_plan_checklist.md`**. Rule vị trí file: [`.cursor/rules/12-src-feature-docs.mdc`](../../.cursor/rules/12-src-feature-docs.mdc).
